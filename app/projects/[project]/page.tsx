...
// import Image from '@/components/dom/common/Image'
...
const Project = () => {
  ...
  useLayoutEffect(() => {
    if (!currentProject) {
      setCurrentProject(projects[params.project as keyof typeof projects])
    }
  }, [params, currentProject, setCurrentProject])
